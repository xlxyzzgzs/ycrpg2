...
if (Imported.YEP_EquipCore) {
    ...
    DataManager.getEquipRequirementStatIndex = function (stat) {
        ...
        if (["MAX HP", "MAXHP", "HP"].contains(stat)) {
            return 0;
        } else if (["MAX MP", "MAXMP", "MP", "MAX SP", "MAXSP", "SP"].contains(stat)) {
            return 1;
    ...
    Window_EquipRequirement.prototype.getRequirements = function () {
        ...
        if (!requirements) {
            if (this._item.baseItemId) {
                this._item.equipRequirements = DataManager.getBaseItem(this._item).equipRequirements;
    ...
    Yanfly.EqReq.Scene_Equip_createCompareWindow = Scene_Equip.prototype.createCompareWindow;
    ...
    Yanfly.EqReq.Scene_Equip_refreshActor = Scene_Equip.prototype.refreshActor;
    ...
    Yanfly.EqReq.Scene_Equip_commandOptimize = Scene_Equip.prototype.commandOptimize;
