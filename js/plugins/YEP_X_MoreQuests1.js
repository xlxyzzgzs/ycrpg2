 ...
 * 在插件列表中的YEP_X_MoreQuests1下。
 * 默认情况下，YEP_QuestJournal插件附带100个任务条目
 * 你可以制作并插入游戏。根据制作的RPG，
 * 100个任务条目可能还不够。此插件是
 * 为Yanfly Engine plugins Quest Journal制作的一系列扩展插件
 * 系统允许比100更高的任务数量。
 *
 ...
 * @text 自动批量处理难度101-200
 * @parent ---Quests 101 to 200---
 * @desc 类型为的任务的默认“难度”|-=AUTO=-|
 * Text codes allowed.
 * @default 简单难度
 *
 * @param From: 101 to 200
 * @text 自动批处理发布人101-200
 * @parent ---Quests 101 to 200---
