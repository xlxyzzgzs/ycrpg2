...
在状态的备注栏中
<IntervalGainHp gainValue=増加値 duration=時間間隔>  血量间隔回复
这样，在赋予状态的期间，对于duration的每个经过时间，只有在gainValue中指定的值HP增加。gainValue中所述修改相应参数的值。
