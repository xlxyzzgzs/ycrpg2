 ...
 *  ============================================================================
 *
 * RPG Maker MV中的商店菜单与RPG Maker VX和RPG中的相同
 * 制造者VX Ace。它是相对基本的，提供了足够的信息，但是
 * 不足以让玩家知道他们到底在买什么或买什么
 * 甚至卖。这个插件使商店能够显示不仅仅是基本的
 * RPG Maker MV中显示的信息，甚至允许自定义命令
 * 插入到命令窗口中。
 *
 * 这个插件还为玩家提供了在一个参数之间制表符的选项
 * 比较模式，全队一次显示个人数据
 * 或者单个演员一次显示所有数据。玩家可以切换
 * 按键盘上的“tab”按钮或
 * 触摸输入参与者或参数的名称。
 *
 *  ============================================================================
 ...
 *  ============================================================================
 *
 * 您可以使用下面的notetag来更改各个商店方面
 *
 * 物品、武器和盔甲标签：
 *
 *   <Price: x>
 *   此notetag允许您超过商品价格999999黄金的默认编辑器限制。
 *
 *   <Sell Price: x>
 *   这将商品的售价设置为x。
 *
...
if (Imported.YEP_X_ItemPictureImg) {
    Yanfly.IPI.Window_ShopInfo_drawItemIcon = Window_ShopInfo.prototype.drawItemIcon;
    Window_ShopInfo.prototype.drawItemIcon = function () {
...
Window_ShopBuy.prototype.drawBuyPrice = function (item, rect) {
    ...
    this.drawCurrencyValue(itemPrice, this.currencyUnit(), rect.x, rect.y, rect.width);
};
...
Yanfly.Shop.Window_ShopStatus_initialize = Window_ShopStatus.prototype.initialize;
...
Yanfly.Shop.Scene_Shop_activateSellWindow = Scene_Shop.prototype.activateSellWindow;
