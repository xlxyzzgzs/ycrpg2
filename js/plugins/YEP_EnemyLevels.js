        ...
        for (var i = 0; i < notedata.length; i++) {
            ...
            if (line.match(/<(?:SHOW LEVEL)>/i)) {
                ...
                if (["MAXHP", "MAX HP", "MHP", "HP"].contains(param)) {
                    param = 0;
                } else if (["MAXMP", "MAX MP", "MMP", "MP", "MAXSP", "MAX SP", "MSP", "SP"].contains(param)) {
                    param = 1;
...
Yanfly.ELV.Game_BattlerBase_isSkillSealed = Game_BattlerBase.prototype.isSkillSealed;
...
Yanfly.ELV.Game_Action_applyItemUserEffect = Game_Action.prototype.applyItemUserEffect;
...
Yanfly.ELV.Game_Interpreter_pluginCommand = Game_Interpreter.prototype.pluginCommand;
