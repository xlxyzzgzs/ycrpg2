 ...
 * 通过在消息中使用某些文本代码，您可以让游戏将其替换为以下内容：
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *
 * Text Code   Function
 *   \V[n]       显示变量的值
...
Window_Base.prototype.processEscapeCharacter = function (code, textState) {
    switch (code) {
        ...
        case "PY":
            ...
            break;
        default:
            Yanfly.Message.Window_Base_processEscapeCharacter.call(this, code, textState);
            break;
    }
};
...
Window_Message.prototype.processEscapeCharacter = function (code, textState) {
    switch (code) {
        ...
        default:
            Yanfly.Message.Window_Message_processEscapeCharacter.call(this, code, textState);
            break;
    }
};
